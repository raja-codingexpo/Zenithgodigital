<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea class="form-control" name="complaint" placeholder="Complaint Description" required></textarea>
								<div class="help-block with-errors"></div>
                            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Complaints Management</div>
                <div class="panel-body">
                    <?php
                    ...
                    if (isset($_GET['resolveSuccess'])) {
                        echo "<div class='alert alert-success'>
                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Complaint Successfully Resolved!
                            </div>";
                    }
                    ?>
                        ...
                        if (mysqli_num_rows($complaint_result) > 0) {
                            ...
                            while ($complaint = mysqli_fetch_assoc($complaint_result)) {
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td>&#8377; <?php echo $complaint['budget'] ?></td>
